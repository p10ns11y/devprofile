...
export function classify(sample) {
  ...
  const stableInnerClip = sample.viewBefore && sample.viewAfter && innerClipStableView(sample);
...
export const RECIPES = Object.freeze({
  ...
  "inner-overflow-preview": "Allowed. Keep data-lcv=preview. Do not treat as a fail.",
  "landmark-missing":
