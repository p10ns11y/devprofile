...
description: >-
  ...
  handling, when to use or skip worktrees, and macOS concurrency. Use when creating
  worktrees, integrating agent task branches, or avoiding lost/overwritten work.
---
