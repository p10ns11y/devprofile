  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore writeups, briefs, and readings on technology, programming, and more."
        />
      </Head>
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        <div className="mb-4 text-center">
          <Link
            href="/"
            className="inline-flex items-center text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-200 text-sm font-medium"
          >
            <svg
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 mb-12">
          Discover a curated collection of insights, summaries, and recommendations across
          technology, programming, and beyond. Dive into user-written posts, external content
          briefs, and reading suggestions with read-aloud functionality.
        </p>
