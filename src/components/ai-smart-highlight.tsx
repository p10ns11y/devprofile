...
const EXPERIENCE_TERMS = new Set([
  ...
  "system architecture",
  "computer science",
  "operations research", // TODO: move this to separate education terms
]);
...
export function AISmartHighlight({
        ...
        const session = await LanguageModel.create({
          initialPrompts: [
            { role: "system", content: SYSTEM_PROMPT },
            {
              role: "user",
              content:
                'Example: "Built scalable React applications using TypeScript and Python backend"',
            },
            {
              role: "assistant",
              content:
                '{"technologies": ["React", "TypeScript", "Python"], "actions": ["Built"], "experience": ["scalable"]}',
            },
          ],
  ...
  }, [children, isMounted, extractKeywords, applyHighlighting]);
