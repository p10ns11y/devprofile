    ...
    >
      ...
      <View bookmark="Header">
        ...
        <View style={styles.contactLine}>
          ...
          <Link src={`tel:${data.contact.phone}`} style={[styles.link, { paddingLeft: 4 }]}>
            {data.contact.phone}
          </Link>
        ...
        <View style={styles.contactLine}>
          <View style={{ display: "flex" }}>
            ...
            >
              ...
              <Text style={{ paddingLeft: 2 }}>{data.cv_social_links.github}</Text>
            </Link>
          </View>
          <View style={{ display: "flex" }}>
            <Link
              src={data.cv_social_links.x}
              style={[styles.link, { paddingLeft: 10, flexDirection: "row", alignItems: "center" }]}
            >
      ...
      <View style={styles.columnContainer}>
        ...
        <View style={styles.rightColumn}>
          ...
          <View
            ...
            id="Accomplishments"
            bookmark={{ title: "Accomplishments", fit: false }}
          >
