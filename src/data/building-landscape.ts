...
export const BUILDING_BLURB: Record<string, string> = {
  ...
  ensembly:
    "Operator kernel under mass-market agents. Grok captures; peram-kernel holds done, pending, and denied so you do not re-pay tokens for the same gate. Pulse-pack syncs memory. Game of Peram is parked. Not a second chat.",
