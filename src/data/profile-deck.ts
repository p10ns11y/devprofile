...
export const profileDeckSlides: ProfileDeckSlide[] = [
  ...
  },
  {
    ...
    chapter: "more",
    title: "Zod",
    bridge: "Upstream — friction found in the wild",
    ossRange: [0, 1],
  },
  {
    id: "oss-react-intl",
    ...
    chapter: "more",
    title: "react-intl",
    bridge: "Upstream — a package that left the laptop",
    ossRange: [1, 2],
  },
  {
    id: "oss-kent",
    ...
    chapter: "more",
    title: "Kent C. Dodds",
    bridge: "Ecosystem — PRs that left the house",
    ossRange: [2, 3],
  },
  {
    id: "oss-boilerplate",
    cue: "react-boilerplate",
    kind: "oss",
    chapter: "more",
    title: "React Boilerplate",
    bridge: "Ecosystem — early React craft",
    ossRange: [3, 4],
  },
  {
    id: "connect",
    ...
    chapter: "more",
    title: "Find me",
    bridge: "One place to start a conversation",
  },
  {
    id: "archive-intro",
    cue: "two-seasons",
...
export const profileDeckNav: ProfileDeckNavChapter[] = [
  ...
  },
  {
    id: "more",
    label: "More",
    firstSlideId: "oss-zod",
    children: [
      { label: "Zod", firstSlideId: "oss-zod" },
      { label: "react-intl", firstSlideId: "oss-react-intl" },
      { label: "Kent", firstSlideId: "oss-kent" },
      { label: "Boilerplate", firstSlideId: "oss-boilerplate" },
