...
export const sampleBriefs: Brief[] = [
  {
    ...
    summary:
      "Phased approach to prioritize essential components for immediate coding, followed by storage solutions, GPU acceleration for AI tasks, and finally, advanced upgrades for long-term performance. Prices are estimated for July 2025 and should be verified with current retailers. The total projected cost ranges from approximately $3,900 to $5,000.", // Update with actual summary
  ...
  },
  {
    ...
    summary:
      "In a world where your smart fridge might snitch on you before you've even set up its password, is 'privacy' just a comforting myth? Let's unpack a bold idea: Being selectively transparent, visible, and fair with data might actually be the smarter move than chasing elusive individual security. Here's why, grounded in the gritty realities of our hyper-connected era. 🛡️🔓", // Update with actual summary
  ...
  },
  {
    ...
    title:
      "Essential macOS Developer Guide: Leveraging M4 with 16GB RAM and 256GB SSD on Limited Resources", // Update with actual title
    date: "2025-06-23", // Update with actual publish date
    tags: ["tech", "macOS", "developer guide", "m4", "mac mini"],
    summary:
      "Comprehensive setup for AI/ML, Data Science/Engineering, DevOps, Web, Mobile (Apple/Android/React Native), and Rust/WebAssembly development on macOS Sequoia.", // Update with actual summary
...
export const sampleReadings: Reading[] = [
  {
    ...
    content:
      "This book provides guidance on writing clean, maintainable code. It covers principles of software craftsmanship, refactoring techniques, and best practices for agile development.",
  ...
  },
  {
    ...
    content:
      "A collection of practical tips and techniques for software development, emphasizing pragmatism, automation, and continuous learning.",
  ...
  },
  {
    ...
    content:
      "This classic book presents 23 design patterns that help solve common software design problems in an object-oriented context.",
  ...
  },
  {
    ...
    content:
      "An exploration of the best features of JavaScript, helping developers write better, more maintainable code.",
  ...
  },
  {
    ...
    content:
      "A series that dives deep into the core mechanisms of JavaScript, helping developers understand the language at a fundamental level.",
  ...
  },
  {
    ...
    content:
      "A novel that illustrates DevOps principles through the story of a struggling IT department and their journey to improvement.",
